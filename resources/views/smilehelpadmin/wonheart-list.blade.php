		...
		<table class="table table-striped- table-bordered table-hover table-checkable display" id="m_table_1">
			...
			<?php $i=1; ?>
				...
				<tr>
					...
					<td>{{$rules->wonheart}}</td>
					<td><a style="background-color: red;color: white" class="btn m-btn--pill    btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder btn_2" href="{{ url('deletewonheart/'.$rules->id) }}">Delete</a></td>

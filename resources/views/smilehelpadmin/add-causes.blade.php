						...
						<div class="row">
							...
							<div class="col-lg-12">
								...
								<div class="m-portlet m-portlet--success m-portlet--head-solid-bg">
                                    ...
                                    <form class="m-form m-form--fit m-form--label-align-right" method="post" action="{{route('storecauses')}}" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        <div class="m-portlet__body">
											...
											<div class="form-group m-form__group row">
												...
												<div class="col-10">
													<input class="form-control m-input @error('subdiscription') is-invalid @enderror" type="text" name="subdiscription" value="" id="example-text-input">
											...
											<div class="form-group m-form__group row">
												...
												<div class="col-10">
													<input class="form-control m-input @error('quote') is-invalid @enderror" type="text" name="quote" value="" id="example-text-input">
												     @error('quote')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>

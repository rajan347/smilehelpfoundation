		...
		<table class="table table-striped- table-bordered table-hover table-checkable display" id="m_table_1">
			...
			<?php $i=1; ?>
				...
				<tr>
					...
					<td>{!!$rules->heading!!}</td>
					<td>{!!$rules->subheading!!}</td>
					<td><a style="background-color: red;color: white" href="{{ url('deletehowtohelp/'.$rules->id) }}"  class="btn m-btn--pill    btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder btn_2">Delete</a></td>

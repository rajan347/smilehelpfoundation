				  ...
				  <td>
				  		...
				  		<form  method="post" action="{{ route('blockuser') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="m-portlet__body">
											...
											<input class="form-control m-input" type="hidden" name="blocku" value="2" id="example-text-input">

						<button style="background-color: red;color: white" class="btn m-btn--pill    btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder btn_2"  type="submit" >Block</button>
</form>

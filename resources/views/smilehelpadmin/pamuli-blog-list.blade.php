		...
		<table class="table table-striped- table-bordered table-hover table-checkable display" id="m_table_1">
			...
			<?php $i=1; ?>
				...
				<tr>
					...
					<td><a style="background-color: red;color: white" href="{{ url('deletepamuliblog/'.$causess->id) }}"  class="btn m-btn--pill    btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder btn_2">Delete</a></td>
					<!-- <td></td> -->

						...
						<div class="row">
							...
							<div class="col-lg-12">
								...
								<div class="m-portlet m-portlet--success m-portlet--head-solid-bg">
                                    ...
                                    <form class="m-form m-form--fit m-form--label-align-right" method="post" action="{{route('storebanner')}}" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        <div class="m-portlet__body">
											...
											<div class="form-group m-form__group row">
												<label for="example-search-input" class="col-2 col-form-label">Banner Image :</label>
												<div class="col-10">
